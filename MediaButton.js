...
export default (function (props) { return (React.createElement(Button, tslib_1.__assign({}, props, { theme: function (currentTheme, themeProps) {
        var _a = currentTheme(themeProps), buttonStyles = _a.buttonStyles, rest = tslib_1.__rest(_a, ["buttonStyles"]);
        return tslib_1.__assign({ buttonStyles: tslib_1.__assign({}, buttonStyles, extract(buttonTheme, themeProps)) }, rest);
    } }))); });
