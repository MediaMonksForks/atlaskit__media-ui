...
var CustomMediaPlayer = /** @class */ (function (_super) {
    ...
    function CustomMediaPlayer() {
        ...
        _this.renderFullScreenButton = function () {
            ...
            return (React.createElement(MediaButton, { appearance: 'toolbar', onClick: _this.onFullScreenClick, iconBefore: icon }));
        };
    ...
    CustomMediaPlayer.prototype.render = function () {
        ...
        return (React.createElement(CustomVideoWrapper, { innerRef: this.saveVideoWrapperRef },
            React.createElement(MediaPlayer, { sourceType: type, src: src, autoPlay: isAutoPlay, onCanPlay: onCanPlay, onError: onError }, function (video, videoState, actions) {
                ...
                var toggleButtonAction = isPlaying ? actions.pause : actions.play;
                var button = (React.createElement(MediaButton, { appearance: 'toolbar', iconBefore: toggleButtonIcon, onClick: toggleButtonAction }));
